...
First, write a function called mapCurrentEvents that maps over the current events object, runs it through a constructor function and
...
const countNumberOfElements = (arr) => {
  // Solution code here...
  return arr.reduce((x) => ++x)
};

/* ------------------------------------------------------------------------------------------------
CHALLENGE 3

Write a function named returnNames that, given the Star Wars data, below, uses reduce to return an array containing the names of the
 characters.
------------------------------------------------------------------------------------------------ */
...
const returnNames = (arr) => arr.reduce((acc, init) => {
  acc.push(init.name);
  return acc;
}, []);
...
------------------------------------------------------------------------------------------------ */
// const reversedString = (str) => str.split("").reduce((acc, item) => item+acc, []);

const reversedString = (str) => {
  function myFunction(acc, item) {
    return item + acc;
  }
  return str.split('').reduce(myFunction, []);
}
...
Write a function named countNumberOfChildren that, given the array of characters, below, uses reduce to return the total number of
...
const countNumberOfChildren = (arr) => {arr.reduce((acc,item)=>{acc+item.children.length},0)
  // Solution code here...
};
