...
let biggerThanLuke = (arr) => {
    // Solution code here...
    return arr.filter(charachter => charachter.mass > 77).map(charachter => charachter.name).join(' - ');
};

/* ------------------------------------------------------------------------------------------------
CHALLENGE 4
Write a function named sortBy that takes in an array of objects, each of which has a particular property, and 
sorts those objects by that property, lowest to highest, returning the same array.
