...
Build a simple express server. Connect a '/hello' route that sends a greeting of your  choice.
 Connect a '/aboutme' route that sends a short bio about you to the front-end. Finally, connect
  a '/favoritefoods' route that sends an array to the front-end of your favorite foods. All other routes should respond with a status of 404.
------------------------------------------------------------------------------------------------ */
...
const count = (target, input) => {
  return input.reduce((numbersCount, currentNumber) => {
    numbersCount += currentNumber.filter(checkEquality).length;
...
const totalSum  = (input) => {
  return input.reduce((numbersCount, currentNumber) => {
    currentNumber = currentNumber.reduce((localNumbersCount, currentNumber) => {
      return localNumbersCount + currentNumber;
    }, 0);
    console.log(currentNumber);
    return numbersCount + currentNumber;
  }, 0);
};
